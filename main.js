...
marker1.bindPopup("<b>Joabi</b><br>Parque Jesus María.").openPopup();
...
marker3.bindPopup("<b>Tienda Etérea</b><br>Perez gamboa.");

var marker4 = L.marker([-18.0167047, -70.25180]).addTo(map);
marker4.bindPopup("<b>Tloc Cookies</b><br>Descripción de la tienda 4.");

var marker5 = L.marker([-18.0129808, -70.24936]).addTo(map);
marker5.bindPopup("<b>Comerical Jhilmar</b><br>Descripción de la tienda 5.");

var marker6 = L.marker([-18.0073255, -70.2475495]).addTo(map);
marker6.bindPopup("<b>Yogurt de casa Sabi</b><br>Descripción de la tienda 6.");

var marker7 = L.marker([-18.00568, -70.22544]).addTo(map);
marker7.bindPopup("<b>Cafetería Facsa Upt</b><br>Descripción de la tienda 7.");
